...
// func (f *Feathercoin) GetBlockchainSyncTxtFeathercoin(synced bool, bci *FeathercoinBlockchainInfoRespStruct) string {
...
func (f *Feathercoin) NewAddress() (models.FTCGetNewAddress, error) {
...
func (f *Feathercoin) ListReceivedByAddress(includeZero bool) (models.FTCListReceivedByAddress, error) {
...
func (f *Feathercoin) WalletSecurityState() (models.WEType, error) {
	wi, err := f.WalletInfo()
	if err != nil {
