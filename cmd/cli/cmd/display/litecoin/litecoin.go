...
var blockChainInfo models.LTCBlockchainInfo
var networkInfo models.LTCNetworkInfo
var ticker models.LTCTicker
var transactions models.LTCListTransactions
var walletInfo models.LTCWalletInfo
var diffGood, diffWarning float64
var lastBCSyncStatus string = ""

func (l LTC) About(coinAuth *models.CoinAuth) string {
	var a app.App
	var ltc ltcImport.Litecoin
	var sCoreVersion string
	info, err := ltc.WalletInfo(coinAuth)
	if err != nil {
...
func (l LTC) LiveTransactions() (containsZeroConfs bool, rows [][]string) {
	var sRows [][]string
...
func (l LTC) LiveWallet() string {
	return "" + balanceTxt() + "\n" +
		"  " + walletSecurityStatusTxt()
}

func (l LTC) RefreshDifficulty() {
	var ltc ltcImport.Litecoin

	diffGood, diffWarning, _ = ltc.NetworkDifficultyInfo()
}

func (l LTC) RefreshNetwork(coinAuth *models.CoinAuth) {
	var ltc ltcImport.Litecoin
...
func (l LTC) RefreshPrice() {
	var ltc ltcImport.Litecoin

	ticker, _ = ltc.UpdateTickerInfo()
}

func (l LTC) RefreshTransactions(coinAuth *models.CoinAuth) {
	var ltc ltcImport.Litecoin

	transactions, _ = ltc.ListTransactions(coinAuth)
}
