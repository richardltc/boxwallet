...
type PIVXBlockchainInfo struct {
	Result struct {
...
type PIVXGetNewAddress struct {
	Result string      `json:"result"`
	Error  interface{} `json:"error"`
	ID     string      `json:"id"`
}

type PIVXListReceivedByAddress struct {
	Result []struct {
